package com.playstamp.home;

public class Home
{	
	private String play_nm, play_img, play_cd;
	private String playrev_cd, user_img, user_nick, title, rating_cd, contents, like_count, comment_count;
